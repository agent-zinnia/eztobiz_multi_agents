...
class DualAgentSystem:
    ...
    async def run_dual_agent_workflow(self, user_query: str, question_rounds: int = 1) -> Dict[str, Any]:
        ...
        for i in range(question_rounds):
            ...
            answer_result = await self.answer_generated_question(generated_question, thread_id)
            ...
            print(f"✅ Step {answer_step} completed. Answer: {answer_result['answer']}")
            ...
            current_result = answer_result["answer"]
